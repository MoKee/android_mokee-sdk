/*
 * Copyright (c) 2011-2016 MoKee Open Source Project
 *
...
public class ProfileManagerService extends MKSystemService {
    ...
    public void onStart() {
        ...
        mWildcardGroup = new NotificationGroup(
                mContext.getString(org.mokee.platform.internal.R.string.wildcardProfile),
                org.mokee.platform.internal.R.string.wildcardProfile,
                mWildcardUUID);
    ...
    private void enforceChangePermissions() {
        mContext.enforceCallingOrSelfPermission(
                mokee.platform.Manifest.permission.MODIFY_PROFILES,
    ...
    private void initialiseStructure() throws XmlPullParserException, IOException {
        XmlResourceParser xml = mContext.getResources().getXml(
                org.mokee.platform.internal.R.xml.profile_default);
        try {
