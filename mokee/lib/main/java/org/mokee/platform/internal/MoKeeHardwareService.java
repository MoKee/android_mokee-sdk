...
import mokee.hardware.IMoKeeHardwareService;
...
/** @hide */
public class MoKeeHardwareService extends MoKeeSystemService {

    private static final boolean DEBUG = true;
    private static final String TAG = MoKeeHardwareService.class.getSimpleName();
    ...
    private class LegacyMKHardware implements MKHardwareInterface {
        ...
        public LegacyMKHardware() {
            ...
            if (mAcceleratedTransform) {
                ...
                mSupportedFeatures |= MoKeeHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION;
                mSupportedFeatures |= MoKeeHardwareManager.FEATURE_READING_ENHANCEMENT;
            }
        }
        ...
        public boolean get(int feature) {
            switch(feature) {
                case MoKeeHardwareManager.FEATURE_READING_ENHANCEMENT:
                    if (mAcceleratedTransform)
        ...
        public int[] getDisplayColorCalibration() {
            ...
            currentCalibration[MoKeeHardwareManager.COLOR_CALIBRATION_RED_INDEX] = rgb[0];
            currentCalibration[MoKeeHardwareManager.COLOR_CALIBRATION_GREEN_INDEX] = rgb[1];
            currentCalibration[MoKeeHardwareManager.COLOR_CALIBRATION_BLUE_INDEX] = rgb[2];
            currentCalibration[MoKeeHardwareManager.COLOR_CALIBRATION_MIN_INDEX] = MIN;
            currentCalibration[MoKeeHardwareManager.COLOR_CALIBRATION_MAX_INDEX] = MAX;
    ...
    public MoKeeHardwareService(Context context) {
        super(context);
        mContext = context;
    ...
    public String getFeatureDeclaration() {
        return MoKeeContextConstants.Features.HARDWARE_ABSTRACTION;
    }
    ...
    @Override
    public void onStart() {
        publishBinderService(MoKeeContextConstants.MK_HARDWARE_SERVICE, mService);
    }

    private final IBinder mService = new IMoKeeHardwareService.Stub() {
        ...
        public int[] getDisplayColorCalibration() {
            mContext.enforceCallingOrSelfPermission(
                    mokee.platform.Manifest.permission.HARDWARE_ABSTRACTION_ACCESS, null);
            if (!isSupported(MoKeeHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION)) {
