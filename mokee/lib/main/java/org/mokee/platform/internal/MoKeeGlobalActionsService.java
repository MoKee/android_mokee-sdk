...
import static mokee.providers.MoKeeSettings.Secure.POWER_MENU_ACTIONS;
import static mokee.providers.MoKeeSettings.Secure.getStringForUser;
import static mokee.providers.MoKeeSettings.Secure.putStringForUser;

import static org.mokee.internal.util.PowerMenuConstants.GLOBAL_ACTION_KEY_BUGREPORT;
import static org.mokee.internal.util.PowerMenuConstants.GLOBAL_ACTION_KEY_LOCKDOWN;
...
import mokee.app.IMoKeeGlobalActions;
 ...
 * @hide
 */
public class MoKeeGlobalActionsService extends MoKeeSystemService {

    private static final String TAG = "MoKeeGlobalActions";
    ...
    public MoKeeGlobalActionsService(Context context) {
        super(context);
    ...
    public String getFeatureDeclaration() {
        return MoKeeContextConstants.Features.GLOBAL_ACTIONS;
    }

    @Override
    public void onStart() {
        publishBinderService(MoKeeContextConstants.MK_GLOBAL_ACTIONS_SERVICE, mBinder);
    }
    ...
    private final IBinder mBinder = new IMoKeeGlobalActions.Stub() {
