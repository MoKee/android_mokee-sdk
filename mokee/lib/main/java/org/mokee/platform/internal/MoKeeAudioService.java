...
import mokee.media.IMoKeeAudioService;
import mokee.platform.Manifest;

public class MoKeeAudioService extends MoKeeSystemService {

    private static final String TAG = "MoKeeAudioService";
    ...
    public MoKeeAudioService(Context context) {
        super(context);
    ...
    public String getFeatureDeclaration() {
        return MoKeeContextConstants.Features.AUDIO;
    }
    ...
    public void onStart() {
        ...
        publishBinderService(MoKeeContextConstants.MK_AUDIO_SERVICE, mBinder);
    }
    ...
    private final IBinder mBinder = new IMoKeeAudioService.Stub() {
    ...
    private void broadcastSessionChanged(boolean added, AudioSessionInfo sessionInfo) {
        Intent i = new Intent(MoKeeAudioManager.ACTION_AUDIO_SESSIONS_CHANGED);
        i.putExtra(MoKeeAudioManager.EXTRA_SESSION_INFO, sessionInfo);
        i.putExtra(MoKeeAudioManager.EXTRA_SESSION_ADDED, added);
