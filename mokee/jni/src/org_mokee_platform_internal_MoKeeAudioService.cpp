...
#define LOG_TAG "MoKeeAudioService-JNI"
...
static const char* const kClassPathName = "org/mokee/platform/internal/MoKeeAudioService";
...
static void
org_mokee_platform_internal_MoKeeAudioService_session_info_callback(int event,
...
static void
org_mokee_platform_internal_MoKeeAudioService_registerAudioSessionCallback(
        JNIEnv *env, jobject thiz, jboolean enabled)
{
    ...
    AudioSystem::setAudioSessionCallback( enabled ?
            org_mokee_platform_internal_MoKeeAudioService_session_info_callback : NULL);
}

static jint
org_mokee_platform_internal_MoKeeAudioService_listAudioSessions(JNIEnv *env, jobject thiz,
...
static JNINativeMethod gMethods[] = {
     {"native_listAudioSessions", "(ILjava/util/ArrayList;)I",
            (void *)org_mokee_platform_internal_MoKeeAudioService_listAudioSessions},
     {"native_registerAudioSessionCallback", "(Z)V",
            (void *)org_mokee_platform_internal_MoKeeAudioService_registerAudioSessionCallback},
};

int register_org_mokee_platform_internal_MoKeeAudioService(JNIEnv *env)
{
