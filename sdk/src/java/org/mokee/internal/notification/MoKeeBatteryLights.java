...
public final class MoKeeBatteryLights {
    private final String TAG = "MoKeeBatteryLights";
    ...
    public MoKeeBatteryLights(Context context, LedUpdater ledUpdater) {
        mContext = context;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            if (mMultiColorBatteryLed) {
                // Light colors
                resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                        MoKeeSettings.System.BATTERY_LIGHT_LOW_COLOR), false, this,
                        UserHandle.USER_ALL);
                resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                        MoKeeSettings.System.BATTERY_LIGHT_MEDIUM_COLOR), false, this,
                        UserHandle.USER_ALL);
                resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                        MoKeeSettings.System.BATTERY_LIGHT_FULL_COLOR), false, this,
                        UserHandle.USER_ALL);
            }
            ...
            if (mCanAdjustBrightness) {
                ...
                resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                        MoKeeSettings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL), false, this,
                        UserHandle.USER_ALL);
                // Battery brightness level in Do Not Disturb mode
                resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                        MoKeeSettings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL_ZEN), false, this,
                        UserHandle.USER_ALL);
            }
        ...
        private void update() {
            ...
            // Low battery pulse
            mLedPulseEnabled = MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.BATTERY_LIGHT_PULSE,
                    1, UserHandle.USER_CURRENT) != 0;

            // Light colors
            mBatteryLowARGB = MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.BATTERY_LIGHT_LOW_COLOR, res.getInteger(
                    com.android.internal.R.integer.config_notificationsBatteryLowARGB),
                    UserHandle.USER_CURRENT);
            mBatteryMediumARGB = MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.BATTERY_LIGHT_MEDIUM_COLOR, res.getInteger(
                    com.android.internal.R.integer.config_notificationsBatteryMediumARGB),
                    UserHandle.USER_CURRENT);
            mBatteryFullARGB = MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.BATTERY_LIGHT_FULL_COLOR, res.getInteger(
            ...
            if (mCanAdjustBrightness) {
                // Battery brightness level
                mBatteryBrightnessLevel = MoKeeSettings.System.getIntForUser(resolver,
                        MoKeeSettings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
                // Battery brightness level in Do Not Disturb mode
                mBatteryBrightnessZenLevel = MoKeeSettings.System.getIntForUser(resolver,
