...
public final class MoKeeNotificationLights {
    private static final String TAG = "MoKeeNotificationLights";
    ...
    public MoKeeNotificationLights(Context context, LedUpdater ledUpdater) {
        mContext = context;
    ...
    public boolean isForcedOn(Notification n) {
        if (n.extras != null) {
            return n.extras.getBoolean(MoKeeNotification.EXTRA_FORCE_SHOW_LIGHTS, false);
        }
        return false;
    }
    ...
    private int getForcedBrightness(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(MoKeeNotification.EXTRA_FORCE_LIGHT_BRIGHTNESS, 0);
        }
        return 0;
    }
    ...
    public int getForcedColor(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(MoKeeNotification.EXTRA_FORCE_COLOR, 0);
        }
        return 0;
    }
    ...
    public int getForcedLightOnMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(MoKeeNotification.EXTRA_FORCE_LIGHT_ON_MS, -1);
        }
        return -1;
    }
    ...
    public int getForcedLightOffMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(MoKeeNotification.EXTRA_FORCE_LIGHT_OFF_MS, -1);
        }
        return -1;
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                    MoKeeSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO), false,
            ...
            if (mCanAdjustBrightness) {
                resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                        ...
                        false, this, UserHandle.USER_ALL);
                resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                        MoKeeSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL_ZEN),
                        false, this, UserHandle.USER_ALL);
            }

            resolver.registerContentObserver(MoKeeSettings.System.getUriFor(
                    MoKeeSettings.System.ZEN_ALLOW_LIGHTS), false, this,
                    UserHandle.USER_ALL);
        ...
        private void update() {
            ...
            mAutoGenerateNotificationColor = MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO,
                    1, UserHandle.USER_CURRENT) != 0;

            // LED default color
            mDefaultNotificationColor = MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR,
                    mDefaultNotificationColor, UserHandle.USER_CURRENT);

            // LED default on MS
            mDefaultNotificationLedOn = MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON,
                    mDefaultNotificationLedOn, UserHandle.USER_CURRENT);

            // LED default off MS
            mDefaultNotificationLedOff = MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF,
            ...
            if (MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE, 0,
                    UserHandle.USER_CURRENT) != 0) {
                parseNotificationPulseCustomValuesString(MoKeeSettings.System.getStringForUser(
                        resolver, MoKeeSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_VALUES,
                        UserHandle.USER_CURRENT));
            }

            // Notification lights with screen on
            mScreenOnEnabled = (MoKeeSettings.System.getIntForUser(resolver,
                    MoKeeSettings.System.NOTIFICATION_LIGHT_SCREEN_ON, 0,
                    UserHandle.USER_CURRENT) != 0);

            // Adustable notification LED brightness.
            if (mCanAdjustBrightness) {
                // Normal brightness.
                mNotificationLedBrightnessLevel = MoKeeSettings.System.getIntForUser(resolver,
                        MoKeeSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
                // Brightness in Do Not Disturb mode.
                mNotificationLedBrightnessLevelZen = MoKeeSettings.System.getIntForUser(
                        resolver, MoKeeSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL_ZEN,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
            }

            mZenAllowLights = MoKeeSettings.System.getIntForUser(resolver,
