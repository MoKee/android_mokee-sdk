...
public final class MKNotificationLights {
    ...
    public boolean isForcedOn(Notification n) {
        if (n.extras != null) {
            return n.extras.getBoolean(MKNotification.EXTRA_FORCE_SHOW_LIGHTS, false);
        }
        return false;
    }
    ...
    private int getForcedBrightness(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(MKNotification.EXTRA_FORCE_LIGHT_BRIGHTNESS, 0);
        }
        return 0;
    }
    ...
    public int getForcedColor(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(MKNotification.EXTRA_FORCE_COLOR, 0);
        }
        return 0;
    }
    ...
    public int getForcedLightOnMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(MKNotification.EXTRA_FORCE_LIGHT_ON_MS, -1);
        }
        return -1;
    }
    ...
    public int getForcedLightOffMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(MKNotification.EXTRA_FORCE_LIGHT_OFF_MS, -1);
        }
        return -1;
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(MKSettings.System.getUriFor(
                    MKSettings.System.ZEN_ALLOW_LIGHTS), false, this,
                    UserHandle.USER_ALL);
        ...
        private void update() {
            ...
            if (mCanAdjustBrightness) {
                ...
                mNotificationLedBrightnessLevelZen = MKSettings.System.getIntForUser(
                        resolver, MKSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL_ZEN,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
            }

            mZenAllowLights = MKSettings.System.getIntForUser(resolver,
