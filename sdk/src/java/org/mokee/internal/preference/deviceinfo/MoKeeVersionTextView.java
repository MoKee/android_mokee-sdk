...
public class MoKeeVersionTextView extends TextView implements View.OnClickListener {
    private static final String TAG = "MoKeeVersionTextView";
    ...
    public MoKeeVersionTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setText(SystemProperties.get(KEY_MOKEE_VERSION_PROP,
