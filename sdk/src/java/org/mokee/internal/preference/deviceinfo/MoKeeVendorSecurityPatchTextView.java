...
public class MoKeeVendorSecurityPatchTextView extends TextView {
    private static final String TAG = "MoKeeVendorSecurityPatchTextView";
    ...
    public MoKeeVendorSecurityPatchTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
