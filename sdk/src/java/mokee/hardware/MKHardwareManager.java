...
public final class MKHardwareManager {
     ...
     *
     * @deprecated This functionality is replaced by AOSP's implementation as of MK60.1
     */
    @Deprecated
    @VisibleForTesting
     ...
     */
    private MKHardwareManager(Context context) {
    ...
    /**
     * Get or create an instance of the {@link mokee.hardware.MKHardwareManager}
     * @param context
     * @return {@link MKHardwareManager}
     */
    public static MKHardwareManager getInstance(Context context) {
        if (sMKHardwareManagerInstance == null) {
            sMKHardwareManagerInstance = new MKHardwareManager(context);
        }
        return sMKHardwareManagerInstance;
    }
    ...
    public static IMKHardwareService getService() {
        ...
        IBinder b = ServiceManager.getService(MKContextConstants.MK_HARDWARE_SERVICE);
        if (b != null) {
            sService = IMKHardwareService.Stub.asInterface(b);
            return sService;
        }
        return null;
    }
    ...
    /**
     * @return current thermal {@link mokee.hardware.ThermalListenerCallback.State}
     */
