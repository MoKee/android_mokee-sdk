...
class HIDLHelper {
    ...
    static HSIC fromHIDLHSIC(vendor.mokee.livedisplay.V2_0.HSIC hsic) {
        return new HSIC(hsic.hue, hsic.saturation, hsic.intensity,
                hsic.contrast, hsic.saturationThreshold);
    }

    static vendor.mokee.livedisplay.V2_0.HSIC toHIDLHSIC(HSIC hsic) {
    ...
    static Range<Integer> fromHIDLRange(vendor.mokee.livedisplay.V2_0.Range range) {
        return new Range(range.min, range.max);
    }

    static Range<Float> fromHIDLRange(vendor.mokee.livedisplay.V2_0.FloatRange range) {
        return new Range(range.min, range.max);
    }
    ...
    static vendor.mokee.touch.V1_0.Gesture toHIDLGesture(TouchscreenGesture gesture) {
