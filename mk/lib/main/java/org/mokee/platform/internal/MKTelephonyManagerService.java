...
import mokee.app.MKTelephonyManager;
import mokee.app.IMKTelephonyManager;
...
public class MKTelephonyManagerService extends MKSystemService {
    ...
    private final IBinder mService = new IMKTelephonyManager.Stub() {
        ...
        public boolean isSubActive(int subId) {
            enforceTelephonyReadPermission();
            return MKTelephonyManagerService.this.isSubActive(subId);
        }
        ...
        public void setSubState(int subId, boolean state) {
            ...
            MKTelephonyManagerService.this.setSubState(subId, state);
        }
        ...
        public boolean isDataConnectionSelectedOnSub(int subId) {
            enforceTelephonyReadPermission();
            return MKTelephonyManagerService.this.isDataConnectionSelectedOnSub(subId);
        }
        ...
        public boolean isDataConnectionEnabled() {
            enforceTelephonyReadPermission();
            return MKTelephonyManagerService.this.isDataConnectionEnabled();
        }
        ...
        public void setDataConnectionState(boolean state) {
            enforceTelephonyModifyPermission();
            MKTelephonyManagerService.this.setDataConnectionState(state);
        }
        ...
        public void setDataConnectionSelectedOnSub(int subId) {
            enforceTelephonyModifyPermission();
            MKTelephonyManagerService.this.setDataConnectionSelectedOnSub(subId);
        }
        ...
        public void setDefaultPhoneSub(int subId) {
            enforceTelephonyModifyPermission();
            MKTelephonyManagerService.this.setDefaultPhoneSub(subId);
        }
        ...
        public void setDefaultSmsSub(int subId) {
            enforceTelephonyModifyPermission();
            MKTelephonyManagerService.this.setDefaultSmsSub(subId);
        }
    };

    public MKTelephonyManagerService(Context context) {
        super(context);
        mContext = context;
    }
    ...
    private void setDefaultPhoneSub(int subId) {
        ...
        SubscriptionManager subscriptionManager = SubscriptionManager.from(mContext);
        /*if (subId == MKTelephonyManager.ASK_FOR_SUBSCRIPTION_ID) {
            if (localLOGD) {
    ...
    private void enforceTelephonyReadPermission() {
        mContext.enforceCallingOrSelfPermission(
                mokee.platform.Manifest.permission.READ_MSIM_PHONE_STATE,
                "MKTelephonyManagerService");
    }

    private void enforceTelephonyModifyPermission() {
        mContext.enforceCallingOrSelfPermission(
                mokee.platform.Manifest.permission.MODIFY_MSIM_PHONE_STATE,
                "MKTelephonyManagerService");
    }
}
